...
class HomeFeedFragment : BaseFragment<FragmentHomeFeedBinding>(), IOnTabClickListener,
        ...
        if (viewModel.type == "feed" && PrefManager.isLogin) {
            ...
            binding.fab.setOnClickListener {
                if (PrefManager.SZLMID == "") {
                    Toast.makeText(requireContext(), getString(R.string.szlm_id_should_not_be_null), Toast.LENGTH_SHORT)
                        .show()
                } else {
    ...
    inner class ItemClickListener : ItemListener {
        override fun onExpand(
            ...
            PopupMenu(view.context, view).apply {
                ...
                setOnMenuItemClickListener(PopClickListener(id, uid, position))
                show()
            }
        }
    ...
    inner class PopClickListener(
        val id: String, val uid: String, val position: Int
    ) :
        ...
        override fun onMenuItemClick(item: MenuItem?): Boolean {
            when (item?.itemId) {
                ...
                R.id.delete -> {
                    ...
                    viewModel.onDeleteFeedReply("/v6/feed/deleteFeed", id, position, newList)
                }
            }
            return true
        }
