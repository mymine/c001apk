...
fun setExtraPic(imageView: ImageView, extraPic: String?) {
    if (extraPic.isNullOrEmpty())
        imageView.apply {
            ...
            link!!.setTint(imageView.context.getColor(R.color.wb))
...
@BindingAdapter(value = ["targetRow", "relationRows"], requireAll = true)
fun setRows(
